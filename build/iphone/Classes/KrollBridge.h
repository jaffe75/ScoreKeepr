...
@interface ScoreKeeperObject : KrollCoverageObject {
#else
@interface ScoreKeeperObject : KrollObject {
#endif
@private
...
extern NSString * ScoreKeeper$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	ScoreKeeperObject *_scorekeeper;
    KrollObject* console;
	BOOL shutdown;
