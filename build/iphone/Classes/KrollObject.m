...
//@interface ScoreKeeperObject : NSObject
//@end

@interface ScoreKeeperObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ScoreKeeperObject class]])
		{
			for (NSString *key in [[(ScoreKeeperObject*)o modules] allKeys])
			{
