...
// in simulator we redefine to format for ScoreKeeper Developer console
...
{\
	NSString * exceptionName = [@"org.scorekeeper." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.scorekeeper";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIScoreKeeperNativeItemNone = -1, 
	UIScoreKeeperNativeItemSpinner = -2,
	UIScoreKeeperNativeItemProgressBar = -3,
	
	UIScoreKeeperNativeItemSlider = -4,
	UIScoreKeeperNativeItemSwitch = -5,
	UIScoreKeeperNativeItemMultiButton = -6,
	UIScoreKeeperNativeItemSegmented = -7,
	
	UIScoreKeeperNativeItemTextView = -8,
	UIScoreKeeperNativeItemTextField = -9,
	UIScoreKeeperNativeItemSearchBar = -10,
	
	UIScoreKeeperNativeItemPicker = -11,
	UIScoreKeeperNativeItemDatePicker = -12,
	
	UIScoreKeeperNativeItemInfoLight = -13,
	UIScoreKeeperNativeItemInfoDark = -14,
	
	UIScoreKeeperNativeItemDisclosure = -15,
	
	UIScoreKeeperNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all ScoreKeeper instances of
