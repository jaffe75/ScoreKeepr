...
/**
 Base class for all ScoreKeeper views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the ScoreKeeper view hierarchy (such as wrapped iOS UIViews) was touched.
